...
#SCHEMA_FILE_PATH = os.path.join("data_schema", "schmea.yaml")
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # 获取 config.py 所在目录
SCHEMA_FILE_PATH = os.path.join(BASE_DIR, "..", "..", "..", "data_schema", "schema.yaml")  # 返回绝对路径
